...
class SpriteTests(unittest.TestCase):
    def test_xpm_loader_reads_dimensions_and_transparency(self) -> None:
        sprite = load_xpm(Path("assets/sprites/hopper.xpm"))
    ...
    def test_black_hole_and_jetpack_sprites_load(self) -> None:
        black_hole = load_xpm(Path("assets/sprites/black_hole.xpm"))
        jetpack = load_xpm(Path("assets/sprites/jetpack.xpm"))
    ...
    def test_new_gameplay_sprites_are_registered(self) -> None:
        shield = load_xpm(Path("assets/sprites/shield.xpm"))
        propeller = load_xpm(Path("assets/sprites/propeller.xpm"))
        ufo = load_xpm(Path("assets/sprites/ufo.xpm"))
        boots = load_xpm(Path("assets/sprites/boots.xpm"))
        rocket = load_xpm(Path("assets/sprites/rocket.xpm"))
        enemy_shot = load_xpm(Path("assets/sprites/enemy_shot.xpm"))
